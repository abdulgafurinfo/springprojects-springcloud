...
public class EndPointBuilder extends RouteBuilder {
	...
	public String targetEndPoint(ServiceConfig serviceConfig) {
		...
		//targetEndPoint = "activemq" + ":" + "queue" + ":" + serviceConfig.getTargetDestination();
		targetEndPoint =  serviceConfig.getRemoteEndPoint() + ":" + serviceConfig.getRemoteDir() +"a" + "?" + "autoCreate=true";
	...
	public void configure() throws Exception {
		...
		from(fileEndPoint).log("{body}").to(targetEndPoint).routeId(serviceConfig.getServiceId());
